...
| C1-C2 | Release publication | GitHub Release URL + released IPA SHA-256 | VERIFIED | [v1.0.4 Release](https://github.com/misaka310/ios-sidestore-sample/releases/tag/v1.0.4) was published by [run 33669611236](https://github.com/misaka310/ios-sidestore-sample/actions/runs/33669611236), job `100379672610`; the IPA asset and manifest were re-downloaded and the post-publication hash matched: `c6d093412aa5d14199f6e0b0c9d7ba065abab00d9d2c81242ce13fe86965330e`. |
| C3-C5 | AltSource generation/hosting | generator test + source validation + stable HTTPS URL | VERIFIED | The same [run 33669611236](https://github.com/misaka310/ios-sidestore-sample/actions/runs/33669611236), job `100379891664`, generated and semantically validated the source, uploaded [artifact `altsource-v1.0.4`](https://github.com/misaka310/ios-sidestore-sample/actions/runs/33669611236/artifacts/9861973060), and deployed [source.json](https://misaka310.github.io/ios-sidestore-sample/source.json). Independent validation confirmed version `1.0.4`, build `5`, HTTPS `downloadURL`, and the same IPA SHA-256. |
